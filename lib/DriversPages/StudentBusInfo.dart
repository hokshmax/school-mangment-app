...
class StudentsBusView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return StudentsBusViewState();
  }

}

class StudentsBusViewState extends State<StudentsBusView> {
  @override
  void initState() {
    getId();
...
//backgroundColor: Colors.white,
        ...
        body: StreamBuilder(
            stream:  FirebaseFirestore.instance.collection("Students").where("busId",isEqualTo: id).snapshots(),
