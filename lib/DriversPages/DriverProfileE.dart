...
class PerantddView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return PerantddViewState();
  }

}

class PerantddViewState extends State<PerantddView> {
  @override
  void initState() {
                                              ...
                                              Row(
                                                  children:[
                                                    ...
                                                    Text('NAME',style: TextStyle(
                                                        ...
                                                        fontWeight: FontWeight.bold)),]),
                                              SizedBox(height: 5,),
                                              Text(snap.data['driverName'].toString(),style: TextStyle(
                                                  fontSize: 24, color: Colors.black
                                              ),),
                                              SizedBox(height: 20,),
                                              Row(
