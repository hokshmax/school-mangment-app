...
class trackChildrenView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return trackChildrenViewState();
  }

}

class  trackChildrenViewState extends State< trackChildrenView > {
  @override
  void initState() {
    getId();
                                ...
                                return SingleChildScrollView(
                                  child: Container(
                                    child: Padding(
                                      ...
                                      child:InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>partnertrack(busId:snap.data.docs.elementAt(index).data()["busId"])));
                                        },
                                        child:  Center(
                                          child: Container(
