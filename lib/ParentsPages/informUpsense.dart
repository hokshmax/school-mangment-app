...
class inFormUpsenseView extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return inFormUpsenseViewState();
  }

}

class inFormUpsenseViewState extends State<inFormUpsenseView> {
  @override
  void initState() {
    getId();
                                ...
                                return SingleChildScrollView(
                                  child: Container(
                                    child: Padding(
                                      ...
                                      child:InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>partnerAtten(StudentId:snap.data.docs.elementAt(index).id,BusId:snap.data.docs.elementAt(index).data()["busId"] )));
                                        },
                                        child:  Center(
                                          child: Container(
