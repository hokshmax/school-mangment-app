...
class editphoneDE extends StatefulWidget{
  int index;
  editphoneDE({this.index});
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return editphoneDEState(index: this.index);
  }

}

class editphoneDEState extends State<editphoneDE>{
  int index;
  TextEditingController getText=TextEditingController();

  editphoneDEState({this.index});
...
//backgroundColor: Colors.white,
    ...
    child: ElevatedButton(onPressed: () async {
                          ...
                          server()
                              .driverChangePhone(newphone: getText.value.text);
                          /*  if(index!=0)
                                     {
