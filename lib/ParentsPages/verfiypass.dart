...
class verfiyPass extends StatefulWidget{
  int index;
  verfiyPass({this.index});
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return verfiyPassState(index: this.index);
  }

}

class verfiyPassState extends State<verfiyPass>{
  int index;
  TextEditingController getText=TextEditingController();

  verfiyPassState({this.index});
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(onPressed: () async {
                                            if(getText.text==snap.data.docs.elementAt(index)
                                              ...
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>editpassPE()));
