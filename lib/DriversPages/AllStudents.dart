...
class allStudentsView extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return allStudentsViewState();
  }

}

class allStudentsViewState extends State<allStudentsView> {
...
//backgroundColor: Colors.white,
        ...
        body:FutureBuilder(builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
          ...
          return  StreamBuilder(
              stream:  FirebaseFirestore.instance.collection("Students").where("busId",isEqualTo: snapshot.data.get('busid')).snapshots(),
